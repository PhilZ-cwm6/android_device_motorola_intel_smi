...
TARGET_BOOTLOADER_BOARD_NAME := intel_smi
...
# Kernel build
TARGET_PREBUILT_KERNEL := device/motorola/intel_smi/prebuilt/kernel
TARGET_KERNEL_SOURCE := device/motorola/intel_smi/kernel/linux-3.0
TARGET_KERNEL_CONFIG := i386_mfld_oxavelar_defconfig
BOARD_CUSTOM_BOOTIMG_MK := device/motorola/intel_smi/tools/mkbootimg
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := device/motorola/intel_smi/recovery/recovery_keys.c
BOARD_HAS_NO_SELECT_BUTTON := true
BOARD_TOUCH_RECOVERY := true

USE_OPENGL_RENDERER := true
BOARD_EGL_CFG := device/motorola/intel_smi/prebuilt/egl.cfg
